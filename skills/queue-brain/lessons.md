...
- 2026-09-13 · all · DEDUPE-BY-REALITY BEATS DEDUPE-BY-TEXT: the queue's dominant corruption is not rephrased duplicates but work ALREADY DONE sitting as backlog (13+ of 47 entries shipped, none caught by wording comparison) — adversarial review of this skill flagged DEDUPE as its weakest rule; SKILL.md now mandates a reality pass ('is the outcome already true?') before ranking, plus a batched verify-then-close sweep at 20+ entries or cold session start (meta: the lesson and the rule it produced landed in the same session — this is the promotion loop working)
